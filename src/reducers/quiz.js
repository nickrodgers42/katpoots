import { GET_QUIZZES, NEXT_QUESTION, GO_TO_NEXT_QUESTION, GET_QUESTION_INDEX, INCREMENT_QUESTION, RESET_INDEX, CHANGE_QUESTION_STATUS, GET_QUESTION_STATUS  } from "../actions/quiz";
