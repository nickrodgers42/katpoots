              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={
                      answers[0] ? answers[0].correctAnswer : false
                    }
                  />
                }
                label="Correct?"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={
                      answers[1] ? answers[1].correctAnswer : false
                    }
                  />
                }
                label="Correct?"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={
                      answers[2] ? answers[2].correctAnswer : false
                    }
                  />
                }
                label="Correct?"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={
                      answers[3] ? answers[3].correctAnswer : false
                    }
                  />
                }
                label="Correct?"
